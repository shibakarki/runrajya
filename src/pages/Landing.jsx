...
export default function Landing({ user, profile, onGetStarted }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] to-[#1a2f4b] text-[#f1f5f9] font-sans overflow-x-hidden relative">
      ...
      {/* HEADER NAVBAR */}
      <header className="sticky top-0 z-50 flex items-center justify-between px-6 py-4 border-b border-[#334155] bg-[#0f172a]/80 backdrop-blur-md">
      ...
      {/* HERO SECTION */}
      <section id="top" className="max-w-5xl mx-auto px-6 py-16 flex flex-col items-center justify-center text-center relative z-10 animate-[fadeInUp_0.8s_ease-out]">
      ...
      <section id="leaderboard" className="max-w-5xl mx-auto px-6 py-12 relative z-10">
      ...
      <section id="map" className="max-w-5xl mx-auto px-6 py-12 relative z-10">
      ...
      {/* FOOTER */}
      <footer className="border-t border-[#334155] py-8 text-center text-[#cbd5e1] bg-[#0f172a]/50 mt-16 relative z-10 flex-shrink-0">
        <p className="text-xs">
